              ...
              <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
                <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                  <div className="text-white lg:w-1/2 lg:mx-6">
                    ...
                    <p className="max-w-xl mt-6 mb-6 ">
                      I’m available for freelance projects, collaborations, and
                      more. Feel free to drop a message!
                    </p>

                    <a
                      className="px-8 py-3  text-sm font-medium tracking-wide text-black hover:text-[#FAFAFA] capitalize transition-colors duration-300 transform bg-[#FAFAFA] rounded-md hover:bg-[#969696] focus:outline-none focus:ring focus:ring-[#cfcece] focus:ring-opacity-50"
                      ...
                      <form className="mt-6" id="form" onSubmit={handleSubmit}>
                        <div className="flex-1">
                          ...
                          <input
                            ...
                            className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-black focus:ring-gray-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                            required
                          />
                        </div>
                        ...
                        <div className="w-full mt-6">
                          ...
                          <textarea
                            className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-black focus:ring-gray-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                            name="message"
                            required
                            placeholder="Message"
                          ></textarea>
                        ...
                        <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide  capitalize transition-colors duration-300 transform text-white  hover:bg-[#969696]  bg-[#626262] hover:text-black rounded-md  focus:outline-none focus:ring  focus:ring-opacity-50 focus:ring-[#cfcece]">
                          get in touch
                        </button>
                      </form>
                      {/* Success Message Animation */}
                      {successMessage && (
                        <div className="mt-4 p-4 bg-green-600 text-white rounded-md animate-bounce">
